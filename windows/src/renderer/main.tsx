...
function FloatingApp() {
  ...
  const [region, setRegion] = useState<{ x: number; y: number; width: number; height: number }>(); const drag = useRef<{ x: number; y: number } | undefined>(undefined); const host = useRef<HTMLDivElement>(null);
  useEffect(() => {
